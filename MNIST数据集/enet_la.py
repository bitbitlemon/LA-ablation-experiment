...
class InitialBlock(nn.Module):
    def __init__(self):
        ...
        self.main_branch = nn.Conv2d(1, 13, kernel_size=3, stride=2, padding=1, bias=False)
        self.ext_branch = nn.MaxPool2d(kernel_size=2, stride=2, padding=0)
        self.bn = nn.BatchNorm2d(13 + 1)  # 13 + 1 = 14
        self.prelu = nn.PReLU(14)
...
class Enet(nn.Module):
    def __init__(self, num_classes=10):
        ...
        self.bottleneck1_0 = DownsamplingBottleneck(14, 16, 64)
